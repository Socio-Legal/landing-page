export const summary = {
  ...
  quote: {
    ...
    author: "Lucía Bouzá",
    position: "Head of Legal & Compliance | DerechoCom",
  },
  button: {
...
export const content = {
  ...
  sections: [
    {
      title: "Un poco sobre DerechoCom",
      texts: [
        "DerechoCom es una empresa de software para la gestión de recursos humanos dirigido principalmente a pequeñas y medianas empresas. La compañía ha experimentado un crecimiento significativo desde su fundación, destacando en la automatización de tareas y trámites relacionados con la gestión de nóminas, gastos, firmas electrónicas, registro horario e informes analíticos para medir la productividad y la eficiencia de procesos.",
        "En 2022, DerechoCom cerró una ronda de 120 millones, liderada por el fondo Atomico y contó con la participación de inversores como Tiger Global, CRV, K-Fund y Creandum. DerechoCom es considerado un “unicornio”, término utilizado para describir a las startups que superan los 1.000 millones de dólares en valoración.",
      ],
    },
    {
