...
export const metadata = {
  title: "Software de Gestión de Participadas para Inversores", // ej., "Nombre del Producto"
  description:
...
export const hero = {
  title: "Solución para Inversores, VC y Fondos", // ej., "Título Principal del Producto"
  description:
