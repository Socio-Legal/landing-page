...
type AnimatedBeamSingleToMultiOriginalProps = {
  className?: string;
...
export const AnimatedBeamSingleToMultiOriginal: FC<
  AnimatedBeamSingleToMultiOriginalProps
> = ({ className, icons = defaultIcons }) => {
