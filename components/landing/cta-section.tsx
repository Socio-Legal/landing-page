            ...
            <div className="absolute z-10">
              ...
              <div className="z-10 mt-4 flex flex-col items-center text-center text-primary">
                ...
                <p className="mt-2 max-w-3xl">
                  Conoce cómo Sttok puede ayudarte en la gestión societaria
                  según tus necesidades y ahorra tiempo y evita errores con el
                  software líder en gestión de sociedades.
                </p>
                <Link
                  href="#"
                  className={cn(
